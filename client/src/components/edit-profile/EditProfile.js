...
class CreateProfile extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        // if (nextprops            // these 3 lines are explanations
        ...
        if(nextProps.profile.profile){
            ...
            profile.social = !isEmpty(profile.social) ? profile.social : {}; // this is empty object because profile.social is an object
    ...
    onSubmit(e) {
        ...
        // The process: Getting everything in the form and call
        // create profile again as createProfile can either create a
        // profile or update the profile
